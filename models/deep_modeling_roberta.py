...
class RobertaForMaskedLM(RobertaPreTrainedModel):
    ...
    def forward(
        ...
        return {
            'logits': self.lm_head(outputs['last_hidden_state'][torch.arange(outputs['last_hidden_state'].size(0)), mask_pos]),
            'hidden_states': outputs['hidden_states'] if self.config.output_hidden_states is not None else None
        }
        # masked_lm_loss = None
        # if labels is not None:
        #     loss_fct = CrossEntropyLoss()
